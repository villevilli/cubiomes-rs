...
///
/// Biomes can be generated either with [`get_biome_at()`] for single points
/// in conjuntion with a [`Cache`] generated by [`new_cache()`]
...
impl Generator {
    ...
    /// initialization if the generator was generated with [`new_without_seed()`]
...
impl Cache<'_> {
    ...
    ///
    /// See example from [`get_cache()`] for example usage
